...
"459842150323060736",   #dim
"568617830258442255",   #revo
"655723300131176468",   #boss
"513818250652680213"    #wold
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title= "__**HQ TRIVIA**__", description="**hq Deep searching.....**", color=0xFF00FF)
        self.embed.set_author(name ='',url=' ',icon_url='')
        self.embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/650965552965353482/656544268357206036/images_1.png")
        ...
        self.embed.set_footer(text=f"Made by ♥ ⎝⧹𝗗𝗿. BOSS™╱⎠ & M̸R̸.̸G̸E̸N̸I̸U̸S̸ K̸I̸N̸G̸"                , \
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NjU4OTE1NDA2NTE3NjMzMDI1.XgHKGg.eQiM18iH4-U9Jjeeuzafu-J7h4E',
                                   bot=False))
    loop.run_forever()
